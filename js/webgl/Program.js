var Program = {
    ...
    */
    load : function() {
     ...
     prg.uPosition    = gl.getUniformLocation(prg, "uPosition");
     prg.uZ = gl.getUniformLocation(prg, "uZ");
     prg.uUp = gl.getUniformLocation(prg, "uUp");
     prg.uRight = gl.getUniformLocation(prg, "uRight");
